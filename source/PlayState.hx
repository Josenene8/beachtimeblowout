...
class PlayState extends MusicBeatState
{
	...
	public static var curStage:String = 'beach';
	...
	override public function create()
	{
		...
		gf = new Character(900, -200, curGf);
		gf.scrollFactor.set(0.95, 0.95);

		dad = new Character(-300, 175, SONG.player2);
		...
		if (FlxG.save.data.songPosition) // I dont wanna talk about this code :(
			{
				...
				songPosBar.createFilledBar(FlxColor.GRAY, 0xFFFF8DC4);
				add(songPosBar);
		...
		healthBar.createFilledBar(0xFFEE3C7C, 0xFF148FEB);
		// healthBar
		add(healthBar);

		// Add Kade Engine watermark
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " | OC owned by Puppyrelp.", 16);
